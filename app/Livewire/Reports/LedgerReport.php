...
class LedgerReport extends Component
{
    ...
    public function getData()
    {
        ...
        foreach($debits as $row)
        {
            ...
            $row['type'] = 'debit';
            $row['amount'] = $row['total']; // normalize
        }  
        ...
        foreach($credits as $row)
        {
            ...
            $row['type'] = 'credit';
            $row['amount'] = $row['received_amount']; // normalize
        }   
    ...
    public function downloadFile()
    {
        ...
        $data = $this->data;
        $first_data = $this->first_data;
        $start_date = $this->start_date;
        $end_date = $this->end_date;
        $lang = $this->lang;

        $pdfContent = Pdf::loadView(
            'livewire.reports.download-report.ledger-report',
            compact(
                'customer',
                'data',
                'first_data',
