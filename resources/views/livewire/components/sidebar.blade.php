    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="@if (Request::is('admin/garment-tracking*')) active-page @endif">
                <a href="{{ route('garment.tracking') }}" class="@if (Request::is('admin/garment-tracking*')) active-page @endif">
                    <iconify-icon icon="mdi:hanger" class="menu-icon"></iconify-icon>
                    <span>Garment Tracking</span>
                </a>
            </li>
            <li class="@if (Request::is('admin/delivery-counter*')) active-page @endif">
                <a href="{{ route('delivery.counter') }}" class="@if (Request::is('admin/delivery-counter*')) active-page @endif">

                    <iconify-icon icon="mdi:truck-delivery-outline" class="menu-icon">
                    </iconify-icon>
            ...
            <li>
                <a href="{{ route('pickup.counter') }}">
                    <iconify-icon icon="mdi:shopping-outline" class="menu-icon">
                    </iconify-icon>
            ...
            @canany(['service_list', 'service_type_list', 'addon_list'])
                <li class="dropdown">
                    <a href="javascript:void(0)">
                        <iconify-icon icon="material-symbols-light:design-services-outline-sharp"
            ...
            @canany(['report_daily', 'report_order', 'report_sales', 'report_expense', 'report_ledger', 'report_tax'])
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        @can('report_daily')
                            <li>
                                <a href="{{ route('reports.business') }}"><i
                                        class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>{{ $lang->data['business_report'] ?? 'Business Report' }}</a>
                            </li>
                            <li>
                        ...
                        @can('report_expense')
                            <li>
                                <a href="{{ route('reports.expense') }}"><i
                                        class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                    {{ $lang->data['expense_report'] ?? 'Expense Report' }}</a>
                            </li>
                        @endcan
                        @can('report_tax')
                            <li>
                        ...
                        @can('setting_mail')
                            <li>
                                <a href="{{ route('settings.mail-settings') }}"><i
                                        class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                    {{ $lang->data['mail_settings'] ?? 'Mail Settings' }}</a>
                            </li>
                        @endcan
                        ...
                        @can('setting_mail')
                            <li>
                                <a href="{{ route('settings.file') }}"><i
                                        class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>{{ $lang->data['file_tools'] ?? 'File Tools' }}
                                </a>
                            </li>
                        @endcan
                        @can('setting_sms')
                            <li>
                                <a href="{{ route('settings.sms') }}"><i
                                        class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>{{ $lang->data['sms_settings'] ?? 'SMS Settings' }}
                                </a>
                            </li>
                        @endcan
                        @can('role_list')
                        ...
                        @can('setting_master')
                            <li>
                                <a href="{{ route('settings.master-settings') }}"><i
                                        class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                    {{ $lang->data['master_settings'] ?? 'Master Settings' }}</a>
                            </li>
                        @endcan
                        @can('setting_theme')
                            <li>
